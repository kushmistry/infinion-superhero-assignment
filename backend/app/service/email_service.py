...
class EmailService:
    ...
    To configure email:
    1. Set up frontend URL in your .env file:
       FRONTEND_BASE_URL=http://localhost:3000  # Your frontend URL

    2. Set up SMTP settings in your .env file:
    ...
    The password reset emails will include links to: FRONTEND_BASE_URL/reset-password?token=...
    """
    def __init__(self):
    ...
    def send_password_reset_email(self, to_email: str, reset_token: str) -> bool:
        ...
        try:
            ...
            Please use this reset link: {reset_link}
